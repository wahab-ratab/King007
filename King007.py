...
=======================================
OWNER •   WAHAB RATAB
FACEBOOK • WAHAB RATAB
GITHUB.  • WWW.GITHUB.COM/wahab-ratab
GANG.    •     S P G
\033[1;97m======================================="""
def tik():
	titik = ['.   ','..  ','... ']
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.youtube.com/channel/UCehUCehsjsjajqsjsjajq')
    else:
        print "Wrong Username"
        os.system('xdg-open https://www.youtube.com/channel/UCehuchsnsnsn')
def methodlogin():
	os.system('clear')
	print logo
	...
	if hos =="":
		...
		time.sleep(1)
		os.system('xdg-open https://www.youtube.com/channel/UCe6wmIyozMOA')
		menu()
	elif hos =="0":
		exit()
	else:
